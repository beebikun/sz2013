...
class ApiRoot(SzApiView):
    def get(self, request, format=None):
        return sz_api_response.Response({
            'static':{
                'static-categories': reverse('static-categories', request=request),
                'static-races': reverse('static-races', request=request),
                'static-genders': reverse('static-genders', request=request),
                'static-faces': reverse('static-faces', request=request),
            },
            'test_mode':{
                'generate-places': reverse('generate-places', request=request),
                'testmode-places': reverse('testmode-places', request=request),
            },
            ...
            'places-explore-in-venues': reverse('place-explore-in-venues', request=request),
